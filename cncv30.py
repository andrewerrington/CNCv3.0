...
font["C"]=( ((41,37), (49,38), (48,40), (47,43), (46,44), (45,46), (44,48),
             ...
             18,1,19,1,21,1,23,0,24,0,26,0,28,0,30,0,32,1,34,1,35,2,37,2,39,3,40,4,41,5,42,7,43,8,45,9,45,11,46,13,47,14,48,16,40,17,40,16,39,15,39,14,38,13,37,11,37,10,36,10,35,9,34,8,33,8,32,7,31,7,30,7,28,7,27,6,26,6,24,6,23,7,21,7,20,7,19,7,18,8,17,8,15,9,14,10,14,11,12,12,12,13,11,14,11,15,10,16,9,17,9,19,9,20,9,21,8,23,8,24,8,25,8,26,8,28,8,29,8,31,8,33,8,34,9,36,9,37,9,38,10,40,11,41,11,43,12,44,12,44,14,46,14,46,15,47,16,48,17,49,18,49,20,49,21,50,22,50,23,50,24,50,26,50,27,50,28,50,30,50,31,50,32,49,33,49,34,47,36,47,37,46,37,45,39,44,39,43,40,41,40,40,41,38,41,37)) )
'''
//D
...
class CNC:
  ...
  while(timeNow - timeX < 200){
    if(digitalRead(SENSOR_X)==0){
      timeX = millis();
    }
    timeNow = millis();
    if(timeX > timeNow){
