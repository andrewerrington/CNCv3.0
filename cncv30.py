...
class CNC:
    ...
    def makeStepX(self,direction):
        ...
        # Wait until the sensor is touching metal on the threaded rod.
        # Quit if the limit switch is actuated
        while self.pi.read(self.SENSOR_X):
            # If the limit switch is 'low' (pressed) then drop out
            if not(self.pi.read(self.SWITCH_X)) and not(direction):
                break
    ...
    def makeStepY(self,direction):
        ...
        while self.pi.read(self.SENSOR_Y):
            # If the limit switch is 'low' (pressed) then drop out
            if not(self.pi.read(self.SWITCH_Y)) and not(direction):
                break
    ...
    def makeStepZ(self,direction):
        ...
        while self.pi.read(self.SENSOR_Z):
            if not(self.pi.read(self.SWITCH_Z)) and not(direction):
                break
...
if __name__ == "__main__":
    ...
    # X rotation sensor, limit switch, servo
    # Y rotation sensor, limit switch, servo
    # Z rotation sensor, limit switch, servo
